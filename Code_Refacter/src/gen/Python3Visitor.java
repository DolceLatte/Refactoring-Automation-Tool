...
public interface Python3Visitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link Python3Parser#decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDecl(Python3Parser.DeclContext ctx);
	/**
	 * Visit a parse tree produced by {@link Python3Parser#input}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInput(Python3Parser.InputContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Python3Parser#deco}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDeco(Python3Parser.DecoContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Python3Parser#func_decl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunc_decl(Python3Parser.Func_declContext ctx);
	/**
