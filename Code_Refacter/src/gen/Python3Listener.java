...
public interface Python3Listener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link Python3Parser#decl}.
	 * @param ctx the parse tree
	 */
	void enterDecl(Python3Parser.DeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#decl}.
	 * @param ctx the parse tree
	 */
	void exitDecl(Python3Parser.DeclContext ctx);
	/**
	 * Enter a parse tree produced by {@link Python3Parser#input}.
	 * @param ctx the parse tree
	 */
	void enterInput(Python3Parser.InputContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#input}.
	 * @param ctx the parse tree
	 */
	void exitInput(Python3Parser.InputContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#deco}.
	 * @param ctx the parse tree
	 */
	void enterDeco(Python3Parser.DecoContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#deco}.
	 * @param ctx the parse tree
	 */
	void exitDeco(Python3Parser.DecoContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Python3Parser#func_decl}.
	 * @param ctx the parse tree
	 */
	void enterFunc_decl(Python3Parser.Func_declContext ctx);
	/**
	 * Exit a parse tree produced by {@link Python3Parser#func_decl}.
	 * @param ctx the parse tree
	 */
	void exitFunc_decl(Python3Parser.Func_declContext ctx);
	/**
